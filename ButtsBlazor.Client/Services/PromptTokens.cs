...
public static class PromptTokens
{
    ...
    public static readonly string[] PortraitShotOptions = {
        "Full-Length Shot",
        "American Shot",
        "Medium Shot",
        "Close-Up Shot",
    ...
    [PromptPart(PromptPart.Character)]
    ...
    [PromptPart(PromptPart.Adjective)]
    ...
    [PromptPart(PromptPart.Improver)]
    public static readonly string[] Improvers =
    {
        "award-winning",
        "masterpiece",
